help:
	...
	@echo "\033[1;32mcomposer-update\033[0m\t\t - Обновить все пакеты для LK.\033[0m"
...
composer-update:
	docker compose run --rm bs-php-cli composer update
composer-install:
	docker compose run --rm bs-php-cli composer install
migrate-up:
